...
INSTALLED_APPS = [
    ...
    # Local apps
    "dmm_backend.accounts",
    "dmm_backend.gallery",
    "dmm_backend.blog",
    "dmm_backend.banner",
    "dmm_backend.license",
    "dmm_backend.complaints",
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "templates", BASE_DIR / "dmm_backend" / "templates"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# WSGI
# -----------------------------
WSGI_APPLICATION = 'dmm_backend.wsgi.application'
...
CORS_ALLOWED_ORIGINS = [
    ...
    # 🔹 Production
    "https://dmmparty.com",
    "https://www.dmmparty.com",
    "https://dmm.vercel.app",
    "https://dmm-test.vercel.app",
]
